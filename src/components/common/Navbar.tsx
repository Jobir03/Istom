...
import { MobileCatalogNavigation } from "./CatalogNavigation";
    ...
    >
      <div className="py-3 px-4 text-sm">
        <p className="text-gray-500">
          Ваш город{" "}
          <span className="text-amber-400 font-medium">Санкт-Петербург</span>,
          уточнить адрес
        </p>
      </div>
      ...
      <div className="container">
        ...
        {activeSection === "catalog" ? (
          ...
          <div className="flex-1">
            ...
            >
              <span className="text-base font-cygre font-medium">
                Избранное
              </span>
            </Link>
